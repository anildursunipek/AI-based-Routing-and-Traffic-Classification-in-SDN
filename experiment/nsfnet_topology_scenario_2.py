...
def startNetwork():
    ...
    # low traffic
    generateTraffic(sender="h10", receiver="h1", getStats=False, bandWidth="1500K")
    generateTraffic(sender="h16", receiver="h14", getStats=False, bandWidth="1500K")
    traffic_type = 1

    # normal traffic
    # generateTraffic(sender="h19", receiver="h1", getStats=False, bandWidth="2525K")
    # generateTraffic(sender="h16", receiver="h14", getStats=False, bandWidth="2525K")
    # traffic_type = 2

    # # high traffic
    # generateTraffic(sender="h10", receiver="h1", getStats=False, bandWidth="100M")
...
def scenerio_2():
    ...
    floodlightRestApi.flowPusher(flow_s0_s1)
    floodlightRestApi.flowPusher(flow_s0_s1_r)
    #--------------------------------
    flow_s1_s7 = {
    ...
    floodlightRestApi.flowPusher(flow_s1_s7)
    floodlightRestApi.flowPusher(flow_s1_s7_r)
    #---------------------------------------
    flow_s7_s10 = {
    ...
    floodlightRestApi.flowPusher(flow_s7_s10)
    floodlightRestApi.flowPusher(flow_s7_s10_r)
    #-------------------------------
    flow_s10_s9 = {
    ...
    floodlightRestApi.flowPusher(flow_h1_h10_1)
    floodlightRestApi.flowPusher(flow_h1_h10_1_r)
    #-------------------------------
    flow_h1_h10_2 = {
        "switch": "00:00:00:00:00:00:00:08",
        "name": "flow_h1_h10_2",
    ...
    floodlightRestApi.flowPusher(flow_h1_h10_2)
    floodlightRestApi.flowPusher(flow_h1_h10_2_r)
    #-------------------------------
    flow_h1_h10_3 = {
        "switch": "00:00:00:00:00:00:00:11",
        "name": "flow_h1_h10_3",
    ...
    floodlightRestApi.flowPusher(flow_h1_h10_3)
    floodlightRestApi.flowPusher(flow_h1_h10_3_r)
    #-------------------------------
    #-------------------------------
    flow_h14_h16_1 = {
        "switch": "00:00:00:00:00:00:00:02",
