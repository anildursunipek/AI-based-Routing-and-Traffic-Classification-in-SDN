...
topos = {'nsfnetTopo' : (lambda: NsfnetTopo())}

"""
sudo mn --custom topologies/nsfnet_topology.py --topo nsfnetTopo --controller=remote,ip=127.0.0.1,port=6653 --switch ovsk,protocols=OpenFlow13 --link=tc
"""